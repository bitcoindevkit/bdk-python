...
class OfflineDescriptorTest(unittest.TestCase):
    ...
    def test_descriptor_bip86(self):
        ...
        descriptor_secret_key: DescriptorSecretKey = DescriptorSecretKey(NetworkKind.TEST, mnemonic, None)
        descriptor: Descriptor = Descriptor.new_bip86(descriptor_secret_key, KeychainKind.EXTERNAL, NetworkKind.TEST)
